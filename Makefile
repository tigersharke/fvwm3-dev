...
GH_ACCOUNT=		fvwmorg
GH_PROJECT=		fvwm3
GH_TAGNAME=		403bae715e87c7f760b6b8af96e6d01ded78089a
...
# This detail has been annoying, why are some manpages all lowercase and some have an initial capital?
# Whether there was a purpose, the vast majority of man1 manpages are all lowercase. Cure this here.
# Also fix the recent change from /usr/local/man to /usr/local/share/man
# It is a mistake to change all these manpages to lowercase only because fvwm scripts use those camelcased,
# instead, for convenience create symbolic links.

post-stage:
	@${MV} ${STAGEDIR}${LOCALBASE}/man/man1/* ${STAGEDIR}${LOCALBASE}/share/man/man1/
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmAnimate.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmanimate.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmAuto.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmauto.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmBacker.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmbacker.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmButtons.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmbuttons.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmCommand.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmcommand.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmConsole.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmconsole.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmEvent.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmevent.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmForm.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmform.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmIconMan.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmiconMan.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmIdent.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmident.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmMFL.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmmfl.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmPager.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmpager.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmPerl.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmperl.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmRearrange.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmrearrange.1
	@${LN} ${STAGEDIR}${LOCALBASE}/share/man/man1/FvwmScript.1 ${STAGEDIR}${LOCALBASE}/share/man/man1/fvwmscript.1
